        ...
        <div class="max-w-7xl mx-auto p-6 lg:p-8">
            ...
            <div>
                <h1 class="mt-6 text-xl font-semibold text-gray-900 dark:text-white text-center">
                    Please login to view and use the system
                </h1>
                <p class="font-semibold text-gray-900 dark:text-white text-center">
                    user account: user1@gmail.com, password: 12345678
                </p>
                <p class="font-semibold text-gray-900 dark:text-white text-center">
                    admin account: admin@gmail.com, password: 12345678
                </p>
            </div>
